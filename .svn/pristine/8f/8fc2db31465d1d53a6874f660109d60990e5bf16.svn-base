...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-sidebar-menu">
            <ul class="top-sidebar-menu">
                <?php echo $__env->renderEach('admin::partials.menu_top', Admin::menu(), 'item'); ?>
            </ul>
        </div>
        <!-- Navbar Right Menu -->
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?php echo e(Admin::user()->user_login); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                <?php echo e(Admin::user()->user_login); ?>
