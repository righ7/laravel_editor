...
<div id="app" class="content-box" v-cloak>
    ...
    <div class="content-box-left">
        ...
        <div class="firstImg_tm" data-ids="">
            <div class="firstImgBox_tm" style="display: none"></div>
            <img src="https://p3a.pstatp.com/obj/temai/18f3e290b28dbd4ddb9fd5386f5918e3f77b0fe8www800-800" class="headImg" data-edit="0">
        ...
        <div class="leadsBox">
            <textarea class="form-control leads" rows="3" placeholder="请输入导语"></textarea>
    ...
    <div class="content-box-right">
        <div class="saveBtnBox">
            ...
            <button type="button" class="btn btn-default commitBtn">提交审核</button>
                                                    ...
                                                    for(var j=0;j<curTemArr.length;j++){
                                                        ...
                                                        if(curTemArr[j].indexOf('t')!=-1){
                                                            ...
                                                            html= '<div class="IntSingle" data-id="'+res.DATA[q].product_id+'">' +
                                                                ...
                                                                '</div>'+
                                                                // '<button type="button" class="btn btn-default edit_title">修改标题</button>'+
...
//                       that.repetitionHint = `重复率：${repetitiveRate}%`;
                    ...
                    if(timingData || title || leads || img){
                        layer.confirm('是否加载缓存的文章数据',function (index) {
                            ...
                            if(title!='' && title != undefined && title != null){
                                ...
                                vm.title=title;
                                vm.titleNum=localStorage.getItem('timingTmTitle').length
                            }
                            ...
                            if(leads!='' && leads != undefined && leads != null ){
                                $('.leads').val(leads);
                            }
                ...
                changePreStyle(){
                    ...
                    if(h<600){
                        $('.refresh-preview').css({
                            'height':h*0.9+'px',
                            'width':h*0.9*356/690+'px',
                            'padding-top':parseInt(h*0.9*89/690)+'px'
                        });
                        $('.refresh-preview .preview-article-content').css({
                            'height':526*h*0.9/690+'px',
                            'width':287*h*0.9/690+'px',
                            'margin-left':35*h*0.9/690+'px'
                        });
                        $('.refreshBtn_tm').css({
                            'top':64*h*0.9/690+'px',
                            'left':48*h*0.9/690+'px'
                        });
                        $('.refresh-preview .bg-white').css({
                            'top':34*h*0.9/690+'px',
                            'right':44*h*0.9/690+'px',
                            'width':22*h*0.9/690+'px',
                            'height':48*h*0.9/690+'px'
                        });
                    }
