<script>
    ...
    let goodsSelectOperate = {
        template: `
            <span>
                <Poptip placement="top" width="400" transfer style="margin-left: 120px;">
                    ...
                    <div slot="content" :style="{ height: height }" style="white-space: normal !important; overflow-y:scroll;">
        ...
        data() {
            return {
                height: document.documentElement.clientHeight * 0.8 + 'px !important',
            }
        },
        computed: {
            goodsSelect: {
