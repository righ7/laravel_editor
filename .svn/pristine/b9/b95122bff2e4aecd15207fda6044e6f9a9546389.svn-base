                        ...
                        <div @click="goodsActive(index)">
                            <div class="card-content" style="width: 165px;margin: 10px auto;">
                                <div style="position: relative;">
                                    ...
                                    <img @click="feedimgclk(goods)" src="{{ asset('images/feedback.png') }}" :style="{ display: errorGoodShow }" style="cursor: pointer;z-index:99;width: 20px;height: 20px;position:absolute;top:0px;right:0;"></img>
        ...
        methods: {
            ...
            getFeedback(){
                ...
                layer.confirm("确定要提交反馈？", {
                    ...
                    $.ajax({
                        url: "{{ route('goods_tag.add_feed_back') }}",
                        type:'GET',
                        dataType:'json',
                        data: {
