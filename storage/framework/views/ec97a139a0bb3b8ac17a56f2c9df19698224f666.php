        ...
        <div style="width: 90%;">
            ...
            <div style="position: relative;height: 30px;margin-top: 16px" v-if="user_mark!=null">
                <Alert style="margin: 0;position: absolute;right: 0;width: 300px;" show-icon>
                    您正在看【TA的文章】，<a href="<?php echo e('/admin/temai_article/temai_good_article'); ?>">点此查看全部</a>
                </Alert>
            </div>
        </div>
        <Row type="flex" justify="center" align="middle">
            <i-col span="23" style="margin-top: 20px">
                <i-table :height="tableHight" size="large" :data="tableData" :columns="tableColumns" stripe></i-table>
            </i-col>
        </Row>
        <Row type="flex" justify="center" align="middle">
    ...
    let vm = new Vue({
                ...
                tableColumns: [
                    {
                        ...
                        render (h,params){
                            let row = params.row;
                            let text = row.title;
                            let href = "<?php echo e(route('temai_article.good_article_detail')); ?>"+'?article='+row.article_id+'&title='+row.title+'&article_type='+row.type;
                                    ...
                                    h('a',{
                                        ...
                                        on: {
                                            click: function(event){
                                                ...
                                                vm.searchArr.title='';
                                                vm.searchArr.read='';
                                                vm.searchArr.comments='';
                                                vm.searchArr.article_type='';
                                                vm.searchArr.order_type='';
                                                vm.searchArr.product_id='';
        ...
        methods: {
            getArticleIssueData() {
                ...
                axios.get("<?php echo e(route('temai_article.articleData')); ?>", {
                    params: {
                        page: 1,
            ...
            toRank(){
                window.location.href="<?php echo e(route('temai_article.author_rank')); ?>";
            },
            dateValueFormat(f,v){
