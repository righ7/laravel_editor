...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/iview.css')); ?>" />
...
<script type="text/javascript" src="<?php echo e(URL::asset('js/iview.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('js/axios.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(URL::asset('js/layer/layer.js')); ?>"></script>
<script src="<?php echo e(asset('lib/Sortable.min.js')); ?>"></script>
<script src="<?php echo e(asset('lib/vuedraggable.min.js')); ?>"></script>

<?php echo $__env->make('vue.vue_components.goods_card.goodsCard', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    vm = new Vue({
        ...
        methods: {
            getData(){
                ...
                axios.get("<?php echo e(route('temai_article.good_article_detail_data')); ?>", {
                    params: {
            ...
            copyAll(){
                ...
                axios.post("<?php echo e(route('temai_article.article_copy_all')); ?>", {
            ...
            saveSingel(){
                ...
                if (copy_single){
                    copy_single=JSON.parse(copy_single);
                    axios.post("<?php echo e(route('temai_article.article_copy_single')); ?>", {
                        article_type: article_type,
                        data: copy_single
                    })
                        .then(function (response) {
            ...
            goodsAddToGroup(group,goods_id,index){
                ...
                axios.get("<?php echo e(route('goods_group/curd_goods_group_detail')); ?>",{
                    params:{
                        curd: 1,
